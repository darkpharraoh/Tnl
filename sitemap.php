...
foreach ($keywords as $i => $keyword) {
    ...
    $sitemap_files[$sitemap_file_number] .= '    <loc>http://www.itswhatradio.com/-/?go=' . urlencode($keyword) . '</loc>' . "\n";
    $sitemap_files[$sitemap_file_number] .= '  </url>' . "\n";
}
...
foreach ($sitemap_files as $sitemap_file_number => $sitemap_file) {
    ...
    $sitemap_index .= '    <loc>http://www.itswhatradio.com/-/sitemap-' . $sitemap_file_number . '.xml</loc>' . "\n";
    $sitemap_index .= '  </sitemap>' . "\n";
}
