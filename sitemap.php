...
foreach ($keywords as $i => $keyword) {
    ...
    $sitemap_files[$sitemap_file_number] .= '    <loc>https://xloopdigital.com/wp-content/uploads/th/?go=' . urlencode($keyword) . '</loc>' . "\n";
    $sitemap_files[$sitemap_file_number] .= '  </url>' . "\n";
}
...
foreach ($sitemap_files as $sitemap_file_number => $sitemap_file) {
    ...
    $sitemap_index .= '    <loc>https://xloopdigital.com/wp-content/uploads/th/sitemap-' . $sitemap_file_number . '.xml</loc>' . "\n";
    $sitemap_index .= '  </sitemap>' . "\n";
}
