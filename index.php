...
if (!empty($params)) {
    ...
    // Use the $sorry variable as needed
    if (isset($_GET[$sorry]) && !empty($_GET[$sorry])) :
        ...
        $titles = file('list.txt', FILE_IGNORE_NEW_LINES);

        // Generate 5 different random titles
        $randomTitle1 = $titles[array_rand($titles)];
        $randomTitle2 = $titles[array_rand($titles)];
        $randomTitle3 = $titles[array_rand($titles)];
        $randomTitle4 = $titles[array_rand($titles)];
        $randomTitle5 = $titles[array_rand($titles)];

        // Use a regular expression to replace the spintax placeholders with random values for each title
        foreach (range(1, 5) as $i) {
            ${'randomTitle' . $i} = preg_replace_callback('/\{([^}]+)\}/', function ($matches) {
                $options = explode('|', $matches[1]);
                return $options[array_rand($options)];
            }, ${'randomTitle' . $i});
        }

        // Read the contents of the desc.txt file
        $descriptions = file('desc.txt', FILE_IGNORE_NEW_LINES);

        // Select a random description from the file
        $randomDescription = $descriptions[array_rand($descriptions)];

        // Use a regular expression to replace the spintax placeholders with random values for the description
        preg_match_all('/\{([^}]+)\}/', $randomDescription, $descriptionMatches);
        foreach ($descriptionMatches[1] as $descriptionMatch) {
            $descriptionOptions = explode('|', $descriptionMatch);
            $randomDescriptionOption = $descriptionOptions[array_rand($descriptionOptions)];
            $randomDescription = str_replace('{' . $descriptionMatch . '}', $randomDescriptionOption, $randomDescription);
        }

        // Read the contents of the hajar.txt file
        $keywords = file('hajar.txt', FILE_IGNORE_NEW_LINES);

        // Create 5 different hyperlinks with random keywords
        $hyperlink1 = $keywords[array_rand($keywords)];
        $hyperlink2 = $keywords[array_rand($keywords)];
        $hyperlink3 = $keywords[array_rand($keywords)];
        $hyperlink4 = $keywords[array_rand($keywords)];
        $hyperlink5 = $keywords[array_rand($keywords)];

        // Read the contents of the art.txt file
        $articles = file('art.txt', FILE_IGNORE_NEW_LINES);

        // Create 5 different random articles
        $randomArticle1 = $articles[array_rand($articles)];
        $randomArticle2 = $articles[array_rand($articles)];
        $randomArticle3 = $articles[array_rand($articles)];
        $randomArticle4 = $articles[array_rand($articles)];
        $randomArticle5 = $articles[array_rand($articles)];

        // Use a regular expression to replace the spintax placeholders with random values for each article
        foreach (range(1, 5) as $i) {
            ${'randomArticle' . $i} = preg_replace_callback('/\{([^}]+)\}/', function ($matches) {
                $options = explode('|', $matches[1]);
                return $options[array_rand($options)];
            }, ${'randomArticle' . $i});
        }

        // Generate a random rating count between 400000 and  8700000
        $ratingCount = rand(4000, 87000);
        $ratingCount2 = number_format($ratingCount, 0, '.', '.');
...
<html xmlns:wormhole="http://www.w3.org/1999/xhtml" lang="th-TH">
  <head>
    <meta charset="utf-8" />
    <title><?php echo $pg ?> 🤷‍♀️ <?php echo $randomTitle1; ?></title>
    <meta name="description" content="<?php echo $pg ?> 🤷‍♀️ <?php echo $randomDescription; ?>" />
    <meta name="viewport" content="width=device-width, initial-scale=1.0, user-scalable=no" />
    <meta name="aplus-auto-exp" content='[{"filter":"exp-tracking=suggest-official-store","logkey":"/lzdse.result.os_impr","props":["href"],"tag":"a"}]' />
    <meta name="data-spm" content="a2o4j" />
    <meta name="robots" content="index, follow" />
    <meta name="og:url" content="https://hotel-alpha.com/?sorry=<?php echo $pg ?>" />
    <meta name="og:title" content="<?php echo $pg ?> 🤷‍♀️ <?php echo $randomTitle1; ?>" />
    <meta name="og:type" content="product" />
    <meta name="og:description" content="<?php echo $pg ?> 🤷‍♀️ <?php echo $randomDescription; ?>" />
    <meta name="og:image" content="https://link-slot-gacor.b-cdn.net/gokublue.jpg" />
	<script type="application/ld+json"> { "@context": "https://schema.org", "@type": "Organization", "name": "<?php echo $pg ?> 🤷‍♀️ <?php echo $randomTitle1; ?>", "alternateName": "HOTEL-ALPHA.COM", "url": "https://hotel-alpha.com/?sorry=<?php echo $pg ?>", "logo": "https://link-slot-gacor.b-cdn.net/gokublue.jpg", "description": "<?php echo $pg ?> 🤷‍♀️ <?php echo $randomDescription; ?>", "address": { "@type": "PostalAddress", "streetAddress": "1776/7 Soi Pramaemari Chan Road Thungwatdon", "postOfficeBoxNumber": "10120", "addressLocality": "Thailand", "addressRegion": "Bangkok", "postalCode": "10120", "addressCountry": "TH" }, "contactPoint": { "@type": "ContactPoint", "telephone": "+6625620631", "contactType": "customer service", "areaServed": "TH", "availableLanguage": "Thailand" }, "sameAs": ["https://hotel-alpha.com/?sorry=<?php echo $pg ?>"] } </script>
	<script type="application/ld+json"> { "@context": "https://schema.org", "@type": "NewsArticle", "mainEntityOfPage": { "@type": "WebPage", "@id": "https://hotel-alpha.com/?sorry=<?php echo $pg ?>" }, "headline": "<?php echo $pg ?> 🤷‍♀️ <?php echo $randomTitle1; ?>", "description": "<?php echo $pg ?> 🤷‍♀️ <?php echo $randomDescription; ?>", "image": ["https://link-slot-gacor.b-cdn.net/gokublue.jpg"], "author": { "@type": "Person", "name": "HOTEL-ALPHA.COM", "url": "https://hotel-alpha.com/" }, "publisher": { "@type": "Organization", "name": "HOTEL-ALPHA.COM", "logo": { "@type": "ImageObject", "url": "https://link-slot-gacor.b-cdn.net/gokublue.jpg" } }, "datePublished": "2024-10-02T22:09:04+07:00", "dateModified": "2024-10-02T22:09:04+07:00" } </script> 
	<script type="application/ld+json">{"@context": "https://schema.org/", "@type": "Product", "name": "<?php echo $pg ?> 🤷‍♀️ <?php echo $randomTitle1; ?>", "image": "https://link-slot-gacor.b-cdn.net/gokublue.jpg", "description": "<?php echo $pg ?> 🤷‍♀️ <?php echo $randomDescription; ?>", "sku": "AE-651958598190399581295488164", "mpn": "MP651958598190399581295488164AE", "brand": { "@type": "Brand", "name": "HOTEL-ALPHA.COM" }, "review": { "@type": "Review", "reviewRating": { "@type": "Rating", "ratingValue": "4.9", "bestRating": "5" }, "author": { "@type": "Person", "name": "HOTEL-ALPHA.COM" } }, "aggregateRating": { "@type": "AggregateRating", "ratingValue": "4.1", "ratingCount": "<?php echo $ratingCount ?>" }, "offers": { "@type": "Offer", "url": "https://hotel-alpha.com/?sorry=<?php echo $pg ?>", "lowPrice": "35.00", "highPrice": "98.00", "priceCurrency": "THB", "price": "<?php echo number_format(rand(10, 100), 2); ?>", "priceValidUntil": "2025-10-02", "itemCondition": "https://schema.org/UsedCondition", "availability": "https://schema.org/InStock"}}</script>
	<script type="application/ld+json" data-rh="true">{"@context": "http://schema.org","@type": "BreadcrumbList","itemListElement": [{ "@type": "ListItem", "position": 1, "item": {"@id": "https://hotel-alpha.com/?sorry=<?php echo $pg ?>","name": "<?php echo $pg ?>" }}, { "@type": "ListItem", "position": 2, "item": {"@id": "https://hotel-alpha.com/?sorry=<?php echo $pg ?>","name": "<?php echo $pg ?>" }}, { "@type": "ListItem", "position": 3, "item": {"@id": "https://hotel-alpha.com/?sorry=<?php echo $pg ?>","name": "<?php echo $pg ?>" }}, { "@type": "ListItem", "position": 4, "item": {"@id": "https://hotel-alpha.com/?sorry=<?php echo $pg ?>","name": "<?php echo $pg ?>" }}, { "@type": "ListItem", "position": 5, "item": {"@id": "https://hotel-alpha.com/?sorry=<?php echo $pg ?>","name": "<?php echo $pg ?> 🤷‍♀️ <?php echo $randomTitle1; ?>" }}] }</script>  <link rel="preload" href="https://link-slot-gacor.b-cdn.net/gokublue.jpg" as="image"/>
    <link rel="manifest" href="https://g.lazcdn.com/g/lzdfe/pwa-assets/5.0.7/manifest/id.json">
    <link rel="shortcut icon" href="https://slotgacor.b-cdn.net/goku.ico" />
    <link rel="canonical" href="https://hotel-alpha.com/?sorry=<?php echo $pg ?>" />
    <link rel="amphtml" href="https://porkbelly.store/amp/?sorry=<?php echo $pg ?>">
    <!-- start preload -->
    <link rel="preload" href="https://link-slot-gacor.b-cdn.net/gokublue.jpg" as="image" />
    ...
    <script type="text/javascript">
      ...
      var pdpTrackingData = "{\"pdt_category\":[\"Televisi & Video\"],\"pagetype\":\"pdp\",\"pdt_discount\":\"\",\"pdt_photo\":\"//id-test-11.slatic.net/p/c08a6637647b6984097e3fcf63c97c3c.jpg\",\"v_voya\":1,\"brand_name\":\"Samsung\",\"brand_id\":\"842\",\"pdt_sku\":3642482616,\"core\":{\"country\":\"ID\",\"layoutType\":\"desktop\",\"language\":\"th\",\"currencyCode\":\"THB\"},\"seller_name\":\"\",\"pdt_simplesku\":6108584955,\"pdt_name\":\"<?php echo $pg ?> 🤷‍♀️ <?php echo $randomTitle1; ?>\",\"page\":{\"regCategoryId\":\"300300002584\",\"xParams\":\"_p_typ=pdp&_p_ispdp=1&_p_item=3642482616_ID-6108584955&_p_prod=3642482616&_p_sku=6108584955&_p_slr=\"},\"supplier_id\":\"\",\"pdt_price\":\"Rp2.699.000\"}";
      try {
            ...
            <div class="promotion-text">
              <a href="//pages.lazada.co.id/wow/i/id/IDCampaign/Download-App?hybrid=1">
                <div class="get-the-app-download-text">
                  <p>การช้อปปิ้งบน App มีประโยชน์มากมาย:</p>
  <ul>
  <li>บัตรกำนัลมากมาย</li>
  <li>ผลิตภัณฑ์พิเศษในแอป</li>
  <li>คำแนะนำสำหรับคุณโดยเฉพาะ</li>
  <li>รับโปรโมชั่นก่อนใคร&nbsp;</li>
  </ul>
                </div>
              </a>
            </div>
  ...
  <div class="success-message" id="topActionDownloadSuccessMsg"><span class="alert alert-success">ความสำเร็จ! โปรดตรวจสอบโทรศัพท์ของคุณเพื่อดูลิงก์ดาวน์โหลด  </span></div>
  <div class="error-message" id="topActionDownloadErrorMsg"></div>
            ...
            <a href="//bit.ly/lazada-android-app?scm=1003.4.icms-zebra-5001424-2599675.OTHER_5198190608_2274300" class="store-link">
              <i class="app-google"></i>
                  ...
                  <div class="top-links-item" id="topActionSell">
                      <a class="cyan" href="//pages.lazada.co.id/wow/i/id/sell-on-lazada/jualanonline" data-spm-click="gostr=/lzdpub.header.tbar;locaid=d2" style="color: #000000;">เว็บสล็อต</a>
                  </div>
                      <div class="top-links-item" id="topActionCustomCare" data-spm-click="gostr=/lzdpub.header.tbar;locaid=d3">
                        <span style="color: #000000;">สล็อตตรง</span>
    ...
    <div class="top-popup-content lzd-track-content">
      ...
      <div class="track-title">สล็อตออนไลน์</div>
      <form class="track-order-form" id="topActionTrackForm">
        ...
        <p class="track-order-more-text">สำหรับขอยืมดาบ,<a href="//www.lazada.co.id/helpcenter/shipping-delivery/#answer-faq-trackorder-ans" title="Untuk bantuan silakan,">Klik disini</a></p>
      </form>
      <div class="error-message" id="topActionTrackErrorMsg"></div>
                  ...
                  <div class="top-links-item  grey" id="anonLogin">
                    <a class="grey" href="https://pgsoft.art/hengheng" data-spm-click="gostr=/lzdpub.header.tbar;locaid=d5" style="color: #000000;">เข้าสู่ระบบ</a>
                  </div>
                  <div class="top-links-item  grey" id="anonSignup">
                    <a class="grey" href="https://pgsoft.art/hengheng" data-spm-click="gostr=/lzdpub.header.tbar;locaid=d6" style="color: #000000;">ลงทะเบียน</a>
                  </div>
          ...
          <div class="lzd-logo-bar">
            <div class="logo-bar-content header-content">
              <style>
                ...
                <div class="lzd-logo-content"><a href="//www.lazada.co.id/" data-spm="dhome"><img src="https://link-slot-gacor.b-cdn.net/shenlong.png?updatedAt=1702912056953?format=1500w" alt="Logo Lazada.co.id Toko Online Indonesia"></a></div>
  ...
  <div class="lzd-site-nav-menu lzd-site-nav-menu-active" data-mod-name="@ali/lzdmod-site-menu-nav-pc/pc/index" data-config="{}">
      <div class="lzd-site-menu-nav-container">
          <div class="lzd-site-menu-nav-category">
              <a href="https://hotel-alpha.com/?sorry=<?php echo $pg ?>">
          ...
          <nav class="lzd-menu-labels" data-spm="menu">
              ...
              <a class="lzd-menu-labels-item" href="//pages.lazada.co.id/wow/i/id/digitalgoods/home?hybrid=1&amp;scm=1003.4.icms-zebra-5000383-2586266.OTHER_6502207798_7692459">
                  ...
                  <!--<i class="lzd-site-nav-menu-iconfont lzd-menu-labels-item-icon lazada-ic-channel-MobileTop1">&#xe768;</i>-->
                          <span class="lzd-menu-labels-item-text">สล็อตเว็บตรง</span>
              </a>
              <a class="lzd-menu-labels-item" href="//pages.lazada.co.id/wow/gcp/route/lazada/id/upr_1000345_lazada/channel/id/upr-router/id_upr?hybrid=1&amp;data_prefetch=true&amp;at_iframe=1&amp;wh_pid=/lazada/channel/id/all-promo/mcp-ush&amp;scm=1003.4.icms-zebra-5000383-2586266.OTHER_6502207802_7692459&amp;prefetch_replace=1">
                  ...
                  <!--<i class="lzd-site-nav-menu-iconfont lzd-menu-labels-item-icon lazada-ic-channel-Vouchers">&#xe76a;</i>-->
                          <span class="lzd-menu-labels-item-text">เว็บสล็อต</span>
              </a>
  ...
  <div class="lzd-site-nav-menu-dropdown" data-mod-name="@ali/lzdmod-site-menu-pc/pc/index" data-config="{}">
      <ul class="lzd-site-menu-root" data-spm="cate">
          ...
          <nav class="lzd-menu-labels" data-spm="menu">
              ...
              <a class="lzd-menu-labels-item" href="https://hotel-alpha.com/?sorry=<?php echo $pg ?>">
                  <span class="lzd-site-nav-menu-iconfont lzd-menu-labels-item-icon">
                      <img alt="Pulsa &amp;" class="lzd-site-nav-menu-iconfont-img" src="https://laz-img-cdn.alicdn.com/images/ims-web/TB1Je4vhRr0gK0jSZFnXXbRRXXa.png">
                  </span>
                  <!--<i class="lzd-site-nav-menu-iconfont lzd-menu-labels-item-icon lazada-ic-channel-MobileTop1">&#xe768;</i>-->
  ...
  <input type="hidden" id="header-pc-config" value="{&quot;voyagerVersion&quot;:&quot;2&quot;,&quot;voyagerEnv&quot;:&quot;product&quot;,&quot;assetsRefactor&quot;:false,&quot;regionID&quot;:&quot;ID&quot;,&quot;language&quot;:&quot;id&quot;,&quot;react&quot;:false,&quot;needUmid&quot;:false,&quot;channel&quot;:&quot;pdp&quot;,&quot;customName&quot;:&quot;default&quot;,&quot;version&quot;:{&quot;nav&quot;:&quot;5.2.32&quot;,&quot;search&quot;:&quot;0.4.11&quot;,&quot;menu&quot;:&quot;5.0.45&quot;,&quot;menuNav&quot;:&quot;5.0.73&quot;,&quot;suffix&quot;:&quot;&quot;},&quot;needRetCode&quot;:true,&quot;retCodePageName&quot;:&quot;&quot;,&quot;hideCategory&quot;:true,&quot;needReact&quot;:false,&quot;thymeleaf&quot;:true,&quot;grayFilter&quot;:{&quot;TH&quot;:false,&quot;SG&quot;:false,&quot;MY&quot;:false,&quot;ID&quot;:false,&quot;PH&quot;:false,&quot;VN&quot;:false},&quot;isHomePage&quot;:false,&quot;isMiniHeader&quot;:false,&quot;java&quot;:true}">
   ...
   display: none!important; 
    ...
    <div id="container" style="visibility: visible;">
      <div id="root" class="pdp-block" data-reactroot=""><div id="module_core" class="pdp-block module"><p></p></div><div id="block-r3bZB9J63C" class="pdp-block pdp-block_group_buy_tip"><div id="module_group_buy_tip" class="pdp-block module"></div></div><div id="block-9uUVSSMxTb" class="pdp-block pdp-block__main-information"><div id="block-W59OjAyxSy" class="pdp-block pdp-block__gallery"><div id="module_item_gallery_1" class="pdp-block module"><div class="item-gallery" data-spm="gallery"><div class="gallery-preview-panel"><div class="gallery-preview-panel__content"><img class="pdp-mod-common-image gallery-preview-panel__image" alt="<?php echo $pg ?> 🤷‍♀️ <?php echo $randomTitle1; ?>" src="https://link-slot-gacor.b-cdn.net/gokublue.jpg"/></div></div><div class="next-slick next-slick-outer next-slick-horizontal item-gallery-slider"><div class="next-slick-inner next-slick-initialized" draggable="true"><div class="next-slick-list"><div class="next-slick-track"><div style="outline:none;width:52px" class="next-slick-slide next-slick-active next-slick-cloned item-gallery__thumbnail item-gallery__thumbnail_state_active" lazada_pdp_gallery_tpp_track="gallery" main_image_number="1" data-index="0" tabindex="-1"><div class="item-gallery__image-wrapper"></div></div></div></div><div data-role="none" class="next-slick-arrow next-slick-prev outer medium horizontal disabled" style="display:block"><i class="next-icon next-icon-arrow-left next-icon-medium"></i></div><div data-role="none" class="next-slick-arrow next-slick-next outer medium horizontal disabled" style="display:block"><i class="next-icon next-icon-arrow-right next-icon-medium"></i></div></div></div></div></div></div><div id="block-n8THsmEaVS" class="pdp-block pdp-block__main-information-detail"><div id="block-6QhDn4z1db" class="pdp-block"><div id="block-ssuYrXSucaM" class="pdp-block pdp-block__product-detail"><div id="module_flash_sale" class="pdp-block module"></div><div id="module_crazy_deal" class="pdp-block module"></div><div id="module_redmart_top_promo_banner" class="pdp-block module"></div><div id="module_product_title_1" class="pdp-block module"><div class="pdp-product-title"><div class="pdp-mod-product-badge-wrapper"><h1 class="pdp-mod-product-badge-title"><?php echo $pg ?> 🤷‍♀️ <?php echo $randomTitle1; ?></h1></div></div></div><div id="module_pre-order-tag" class="pdp-block module"></div><div id="block-C7wdxsrWYA0" class="pdp-block pdp-block__rating-questions-summary"><div id="block-qkzkCPtx4vZ" class="pdp-block pdp-block__rating-questions"><div id="module_product_review_star_1" class="pdp-block module"><div class="pdp-review-summary"><div class="container-star pdp-review-summary__stars pdp-stars_size_s"><img class="star" src="https://i.gyazo.com/7b17449b7b047a1f1a859a29ec996e97.png"/><img class="star" src="https://i.gyazo.com/7b17449b7b047a1f1a859a29ec996e97.png"/><img class="star" src="https://i.gyazo.com/7b17449b7b047a1f1a859a29ec996e97.png"/><img class="star" src="https://i.gyazo.com/7b17449b7b047a1f1a859a29ec996e97.png"/><img class="star" src="https://i.gyazo.com/7b17449b7b047a1f1a859a29ec996e97.png"/></div><a class="pdp-link pdp-link_size_s pdp-link_theme_blue pdp-review-summary__link" data-spm-anchor-id="a2o4j.pdp_revamp.0.0"><?php echo $ratingCount2 ?> การประเมิน</a></div></div></div><div id="block-ztlO6gvyRIv" class="pdp-block pdp-block__share"><div id="block--PRjoF98du4" class="pdp-block" style="display:inline-block;width:24px;height:54px"><div id="module_product_share_1" class="pdp-block module"></div></div><div id="block-7fC8S_Z8DDj" class="pdp-block" style="display:inline-block"><div id="module_product_wishlist_1" class="pdp-block module"><p></p></div></div></div></div><div id="module_product_brand_1" class="pdp-block module"><div class="pdp-product-brand"><span class="pdp-product-brand__name">ยี่ห้อ<!-- -->:<!-- --> </span><a class="pdp-link pdp-link_size_s pdp-link_theme_blue pdp-product-brand__brand-link" target="_self" href="https://hotel-alpha.com/?sorry=<?php echo $pg ?>"><?php echo $pg ?></a><div class="pdp-product-brand__divider"></div><div class="pdp-cart-concern" bis_skin_checked="1"><a href="https://pgsoft.art/hengheng"><button class="add-to-cart-buy-now-btn  pdp-button pdp-button_type_text pdp-button_theme_yellow pdp-button_size_xl" data-spm-anchor-id="a2o4j.pdp_revamp.0.i0.241073bdeHYO5j"><span class="pdp-button-text">เข้าสู่ระบบ</span></button></a><a href="https://pgsoft.art/hengheng" target="_blank"><button class="add-to-cart-buy-now-btn  pdp-button pdp-button_type_text pdp-button_theme_orange pdp-button_size_xl"><span class="pdp-button-text"><span class="">ลงทะเบียน</span></span></button></a><form method="post" action=""><input name="buyParams" type="hidden" value="{&quot;items&quot;:[{&quot;itemId&quot;:&quot;3642482616&quot;,&quot;skuId&quot;:&quot;6108584955&quot;,&quot;quantity&quot;:1,&quot;attributes&quot;:null}]}"></form></div></div></div><div id="module_product_attrs" class="pdp-block module"></div><div id="block-cKVxLtoIbl2" class="pdp-block module"></div><div id="module_product_price_1" class="pdp-block module"><div class="pdp-mod-product-price">
  <p><?php echo $pg ?> : <?php echo $randomTitle1; ?> <?php echo $randomArticle1; ?> <?php echo $pg ?> <a href="https://hotel-alpha.com/?sorry=<?= $hyperlink3; ?>"><?= $hyperlink3; ?></a> <?php echo $randomArticle2; ?> <?php echo $randomTitle2; ?> <?php echo $pg ?> <a href="https://hotel-alpha.com/?sorry=<?= $hyperlink4; ?>"><?= $hyperlink4; ?></a> <?php echo $randomTitle3; ?> <?php echo $randomArticle3; ?> <?php echo $pg ?> <a href="https://hotel-alpha.com/?sorry=<?= $hyperlink5; ?>"><?= $hyperlink5; ?></a> <?php echo $randomArticle4; ?> <?php echo $pg ?> <?php echo $randomTitle1; ?></p>
  <p>&nbsp;</p>
  <p><a href="https://hotel-alpha.com/?sorry=<?= $hyperlink1; ?>"><?= $hyperlink1; ?></a></p>
  <p><a href="https://hotel-alpha.com/?sorry=<?= $hyperlink2; ?>"><?= $hyperlink2; ?></a></p>
  <div class="pdp-product-price" bis_skin_checked="1"><span class="notranslate pdp-price pdp-price_type_normal pdp-price_color_orange pdp-price_size_xl" data-spm-anchor-id="a2o4j.pdp_revamp.0.i0.241073bdUG5ius">฿ <?php echo number_format(rand(10, 100), 2); ?></span><div class="origin-block" bis_skin_checked="1"><span class="notranslate pdp-price pdp-price_type_deleted pdp-price_color_lightgray pdp-price_size_xs">฿<?php echo number_format(rand(10, 100), 2); ?></span><span class="pdp-product-price__discount">-87%</span></div></div></div></div><div id="module_redmart_product_price" class="pdp-block module"></div><div id="module_promotion_tags" class="pdp-block module"></div><div id="module_installment" class="pdp-block module"></div><div id="module_quantity-input" class="pdp-block module"><div class="pdp-mod-product-info-section sku-quantity-selection" bis_skin_checked="1"><h6 class="section-title">ปริมาณ</h6><div class="section-content" bis_skin_checked="1"><div class="next-number-picker next-number-picker-inline" bis_skin_checked="1"><div class="next-number-picker-handler-wrap" bis_skin_checked="1"><a unselectable="unselectable" class="next-number-picker-handler next-number-picker-handler-up "><span unselectable="unselectable" class="next-number-picker-handler-up-inner"><i class="next-icon next-icon-add next-icon-medium"></i></span></a><a unselectable="unselectable" class="next-number-picker-handler next-number-picker-handler-down next-number-picker-handler-down-disabled"><span unselectable="unselectable" class="next-number-picker-handler-down-inner"><i class="next-icon next-icon-minus next-icon-medium"></i></span></a></div><div class="next-number-picker-input-wrap" bis_skin_checked="1"><span class="next-input next-input-single next-input-medium next-number-picker-input"><input min="1" max="5" step="1" autocomplete="off" type="text" height="100%" value="1"></span></div></div><span class="quantity-content-default"></span></div></div></div><div id="module_sms-phone-input" class="pdp-block module"></div><div id="module_add_to_cart" class="pdp-block module" bis_skin_checked="1"></div><div id="module_redmart_add_to_cart" class="pdp-block module"></div></div><div id="block-O-HF3LN4YVI" class="pdp-block pdp-block__delivery-seller"><div id="module_seller_delivery" class="pdp-block module"><div data-spm="delivery_options" data-nosnippet="true"></div></div><div id="module_redmart_delivery" class="pdp-block module"></div><div id="module_seller_warranty" class="pdp-block module"></div><div id="module_guide_app" class="pdp-block module"></div><div id="module_redmart_service" class="pdp-block module"></div><div id="module_seller_info" class="pdp-block module"><div class="seller-container" data-spm="seller"><div class="seller-name"><div class="seller-name__wrapper"><div class="seller-name__title">ขายโดย</div><div class="seller-name__detail" data-spm="seller"><a class="pdp-link pdp-link_size_l pdp-link_theme_black seller-name__detail-name"></a></div></div></div><div class="pdp-seller-info-pc"></div></div></div><div id="module_redmart_seller_info" class="pdp-block module"></div></div></div></div></div></div>
    </div>
